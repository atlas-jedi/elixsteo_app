defmodule ElixsteoAppWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ElixsteoAppWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ElixsteoAppWeb.Gettext, "errors", msg, opts)
    end
  end
